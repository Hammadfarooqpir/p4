...
var bricks = [
  { x: 600, y: 20, w: 1200, h: 40 }, 
  { x: 550, y: 450, w: 1200, h: 40 }, 
  { x: 15, y: 235, w: 40, h: 390 }, 
  ...
  { x: 1900, y: 450, w: 1400, h: 40 }, 
  { x: 1900, y: 20, w: 1400, h: 40 }, 
...
function moveBricks() {
  if (keyIsDown(RIGHT_ARROW) && (gameState === "play" || gameState === "initial")) {
    ...
    if (allbricks[3].body.position.x > -1300) {
      ...
      for (var i = 0; i < allbricks.length; i++) {
       //Write code to decrease x-position of allBricks[i] by 3
  ...
  if (keyIsDown(UP_ARROW)) {
    // Write code to apply force to ball.
...
function moveSpider() {
  //spider1
  //Write code here to display spider1
spider1.display();
  
  //Write code here to set veocity to spider1
  ...
  //spider2
  //Write code here to display spider2
  spider2.display();
  //Write code here to set veocity to spider2
